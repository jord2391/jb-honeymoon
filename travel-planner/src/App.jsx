...
const sampleData = {
  ...
  hotels: [
    { name: "Kauai Kailani 2 Bedroom Condo (KK116)", location: "Princeville", checkIn: "Sept 11", checkOut: "Sept 18", nights: 7, amenities: ["Check-in: 3 p.m.", "Check-out: 10 a.m.", "Confirmation #43117", "Managed by Princeville Vacation Rentals", "Concierge: 1-855-On-Kauai / fun@kauaiva.com"] },
  ],
  dining: [
